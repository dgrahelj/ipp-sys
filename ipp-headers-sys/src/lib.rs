...
pub use ipp_2022::*;
#[cfg(feature="2022")]
const _FORCE_UNIQUE_FEATURE: ::std::os::raw::c_int = 2022;

// Intentionally trigger a compile time error to force a feature flag specifying
// version to be used.
#[cfg(not(any(feature = "2017", feature = "2018", feature = "2019", feature = "2022")))]
compile_error!("You are attempting to compile without a required feature flag \
    being used. You must use one of either `2017`, `2018`, `2019`, `2022`");
